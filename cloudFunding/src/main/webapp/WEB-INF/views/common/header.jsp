...
<link rel="dns-prefetch" href="tumblbug-assets.imgix.net/">
<link rel="dns-prefetch" href="tumblbug-pci2.imgix.net/">
<link rel="dns-prefetch" href="tumblbug-psi.imgix.net/">
<link rel="dns-prefetch" href="tumblbug-upi.imgix.net/">
...
<meta data-react-helmet="true" property="og:image"
	content="../tumblbug-assets.imgix.net/brand/tumblbug_introduction.png" />
...
<meta data-react-helmet="true" property="og:title"
	content="티키타카 tikitaka" />
<meta data-react-helmet="true" property="og:description"
	content="창작자를 위한 크라우드펀딩 플랫폼 티키타카" />
...
<meta data-react-helmet="true" name="twitter:title"
	content="텀블벅 tumblbug" />
<meta data-react-helmet="true" name="twitter:description"
	content="창작자를 위한 크라우드펀딩 플랫폼 티키타카" />
<link rel="stylesheet" type="text/css"
	href="d2om2e6rfn032x.cloudfront.net/wpa/app.f0ed3932e778a7f95ef1c52983d12741.css">
<link href=tumblbug-assets.imgix.net/appicon/favicon/favicon-32x32.png
...
<script type="application/javascript">
	 window.MOBX_STATE = {"app":{"ssrLocation":"/"},
			 "currentUser":{"isLoading":false,"isLoaded":true,
				 "id":null,"uuid":null,"fullname":null,"userPermalink":null,
				 "avatarUrl":"https://tumblbug-upi.imgix.net/defaults/avatar_1.png?ixlib=rb-1.1.0&w=200&h=250&auto=format%2Ccompress&fit=facearea&facepad=2.0&ch=Save-Data&mask=ellipse&s=47160c157911f653f6dcd76e296f26b4",
				 "email":null,"isCreator":false,"isAdmin":false}, }
			 "pledgeStore":{"apiEndpoint":"/api/v1/pledges.json?fields=id,createdAt,amount,isSurveyRequested,isSurveyResponded,paymentStatus&project=title,coverImageUrl,creatorName,fundingStatus&reward=description,items&&coverImageUrl[h]=240&coverImageUrl[w]=320&coverImageUrl[fit]=crop",
				 "isLoading":false,"isLoaded":false,"pledges":[],"pledgesCount":{},"currentPage":1,"filterType":"all","isPledgeDataLoading":false,"isMetaDataLoaded":false,"isPledgeDetailsDataLoading":true},"surveyStore":{"apiEndpoint":"/api/v1/pledges.json?fields=id,createdAt,amount,isSurveyRequested,isSurveyResponded,paymentStatus&project=title,coverImageUrl,creatorName,fundingStatus&reward=description,items&filter=surveyResponseNeeded&coverImageUrl[h]=240&coverImageUrl[w]=320&coverImageUrl[fit]=crop"},
			 }
			 "taxpayerInformationStore":{"isLoaded":false},"collectionStore":{
				 "collections":{"0c2e12a5-0778-4a9d-9879-bd5aad92bc2e":{"id":"0c2e12a5-0778-4a9d-9879-bd5aad92bc2e","title":"에디터 추천 프로젝트","permalink":"editorspick","isPublic":true,"description":"텀블벅 분야별 에디터들이 매주 주목할 만한 프로젝트들을 추천해 드립니다.","authorId":136643,"coverImage":{"imageUrl":"https://tumblbug-cci.imgix.net/0c2e12a5-0778-4a9d-9879-bd5aad92bc2e/c6fa60a7-5a3e-4b01-9593-e05d020ef479.jpg?ixlib=rb-1.1.0&w=465&h=465&q=100&fit=crop&s=7cd29efe8a5263a0c042f1825befcbf9","color":"#adbfbd"},"projects":[{"title":"보드게임 부산","summary":"항구 도시인 부산의 항만을 테마로 한 유로스타일의 보드 게임입니다.","permalink":"boardgamebusan","category":"board-game","fundingGoal":20000000,"fundingDeadline":"2018-07-27T23:59:59+09:00","coverImageUrl":"https://tumblbug-pci.imgix.net/17e8ba8d2822296ea6f62e6f9168faf7ea534815/e32b7aef51d5b44a6fdc1e7b8fa19fad8e6e2a8e/4ade714d59c52a43da8cb9825caf3e45507ec8bc/75dd9558-2783-4e2e-8583-3c89ced938c3.jpg?ixlib=rb-1.1.0&w=620&h=465&auto=format%2Ccompress&lossless=true&fit=crop&s=adec0753266be4805de91d04e8e58162","id":"82477910-be60-412c-b817-949d44f819ce","creatorName":"위치스브루","fundingStatus":"ongoing_not_reached","fundedAmount":11310000},
			 }
...
.fqdqdO {
	display: inline-block;
	background-image:
		url(tumblbug-assets.imgix.net/assets/user-accountd986.png?s=08b1f9ecf24209994ac9b81900936c0e);
	width: 28px;
	height: 28px;
...
<body>
	<div id="react-view">
		<div data-reactroot="" data-reactid="1"
			data-react-checksum="1549880817">
			<!-- react-empty: 2 -->
			<div data-reactid="3">
							...
							<div class="SiteHeader__SiteHeaderMenu-s1s56ls8-1 bteafZ"
								...
								<div class="SiteHeader__LeftMenu-s1s56ls8-2 kZLTLQ"
									...
									<button class="SiteHeader__LinkButton-s1s56ls8-7 hcvfVq"
										onclick="hideHeader();" data-reactid="9">
									...
									<span class="SiteHeader__ForMobile-s1s56ls8-9 kizyZz"
										data-reactid="12"> <a
										class="SiteHeader__LinkItem-s1s56ls8-6 cfMrMC"
										href="start.html" data-reactid="13"> <span
											class="SiteHeader__ItemLabel-s1s56ls8-8 iGOIal"
											data-reactid="14">프로젝트 올리기</span>
									</a>
									</span>
								</div>
								<div class="SiteHeader__CenterMenu-s1s56ls8-3 hHUgvf"
									data-reactid="15">
									<a class="SiteHeader__ButtonLink-s1s56ls8-5 bpfGNO"
										href="/tktk/index.jsp" data-reactid="16">
										<div class="TumblbugLogo__TumblbugLogo-s9od1ls-0 JUlEd"
											data-reactid="17">
											<img id="tumblbug_logo" data-reactid="18"
												src="/cloudFunding/src/main/webapp/images/logo.png" />
										</div>
									</a>
								</div>
								<div class="SiteHeader__RightMenu-s1s56ls8-4 buZCDD"
									...
									<a class="sc-gzVnrw imIxKd" href="login.html" data-reactid="30">
										<span class="SiteHeader__ItemLabel-s1s56ls8-8 iGOIal"
										data-reactid="31">로그인 / 회원가입</span> <span
